...
/**
 * The table class for the &quot;CHAT_ChatUser&quot; database table.
 *
 * @author Brian Wing Shun Chan
 * @see ChatUser
 * @generated
 */
public class ChatUserTable extends BaseTable<ChatUserTable> {

	public static final ChatUserTable INSTANCE = new ChatUserTable();

	public final Column<ChatUserTable, Long> userId = createColumn(
		"userId", Long.class, Types.BIGINT, Column.FLAG_PRIMARY);
	public final Column<ChatUserTable, String> fullName = createColumn(
